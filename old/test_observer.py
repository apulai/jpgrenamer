...
class Observer1:
    def update(self, subject, attrname, value):
        print("Observer1: Subject {} has updated attr {} to {}".format(subject.name, attrname, value))


class Observer2:
    def update(self, subject, attrname, value):
        print("Observer2: Subject {} has updated attr {} to {}".format(subject.name, attrname, value))
